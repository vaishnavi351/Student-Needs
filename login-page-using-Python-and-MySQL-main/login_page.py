...
class login_page:
    def __init__(self, root):
        ...
        #==============================DESIGN PART===================================
        #=============================================================================
        self.img = PhotoImage(file="Images/sk.png")

 

        self.frame1 =LabelFrame(self.window, bg="Black",padx=16,pady=16)
        F1_L1=Label(self.frame1,image=self.img,bg='black')
        F1_L1.grid(rowspan=3,column=3,ipady=230,ipadx=20,sticky=N+S)
    ...
    def login_func(self):
        if self.email_entry.get()=="" or self.password_entry.get()=="":
            ...
            try:
                connection=pymysql.connect(host="localhost",user="root",password="Sahil@1234",database="student_database")
                ...
                if row == None:
                    ...
                    messagebox.showinfo("Success","Wellcome to the Student Need",parent=self.window)
